...
plot [0:2000] [-1000:300] \
    ...
    pglc using ($1*1000):3:4 with filledcu notitle lc rgb "#E0E0E0", pglc using ($1*1000):2 with lines title 'PG/PI with LC' lc "#616161", \
    pgnolc using ($1*1000+5):3:4 with filledcu notitle lc rgb "#BDBDBD", pgnolc using ($1*1000+5):2 with lines title 'PG/PI without LC' lc "#212121"
